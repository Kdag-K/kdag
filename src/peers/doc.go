// Package peers defines the concept of a Kdag peer and implements functions
// to manage collections of peers.
//
// A Kdag peer is an entity that operates a Kdag node. When a peer belongs
// to a collection of peers engaged in a Kdag network, we refer to it as a
...
// validator-set at a given time in a Kdag network, may become out of date as
...
//
// Upon starting up, Kdag expects to find a peers.json file, and optionaly a
...
// the inception of the Kdag network. If a  peers.genesis.json file is not
