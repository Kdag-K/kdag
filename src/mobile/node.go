...
func New(
	...
	v.SetConfigName("kdag")  // name of config file (without extension)
	...
	if err := v.ReadInConfig(); err == nil {
		...
		babbleConfig.Logger().Debugf("No config file found in: %s", filepath.Join(configDir, "kdag.toml"))
	} else {
	...
	engine := kdag.NewBabble(babbleConfig)
